...
const Editprofile = ({
  ...
  useEffect(() => {
    ...
    setFormData({
      ...
      status: !profile.website ? "" : profile.status,
  ...
  return (
    <Fragment>
      ...
      <p className="lead">
        <i className="fas fa-user"></i> Let's edit some information to update
        your profile.
      </p>
      ...
      <form className="form" onSubmit={e => onSubmit(e)}>
        ...
        <div className="form-group">
          <input
            ...
            onChange={onChange}
          />
          <small className="form-text">Add your Company name if you have</small>
        </div>
        <div className="form-group">
          <input
            type="text"
          ...
          />
          <small className="form-text">
            Could be your own or a company website if you have
          </small>
        </div>
        <div className="form-group">
          <input
          ...
          />
          <small className="form-text">
            City & state suggested (eg. Lahore, Pakistan)
          </small>
        </div>
        <div className="form-group">
          <input
